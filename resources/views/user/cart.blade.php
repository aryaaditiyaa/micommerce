...
@section('content')
    <div class="bg-white">
        <div class="max-w-2xl mx-auto py-4 px-4 sm:px-6 lg:max-w-7xl lg:px-0">
                                ...
                                <li class="p-4 flex">
                                    <div class="flex-shrink-0 w-24 h-24 border border-gray-200 rounded-md overflow-hidden">
                                        <img
                                            ...
                                            alt="Salmon indigo fabric pouch with match zipper, gray zipper pull, and adjustable hip belt."
            ...
            @else
                <div class="max-w-3xl m-auto mt-20">
                    <div class="flex justify-center mb-10">
                        <img src="{{ asset('img/empty-cart.svg') }}" class="w-72" alt="">
                    </div>

                    <div class="flex flex-wrap items-center gap-4 text-xl lg:text-4xl justify-center">
                        <h3 class="font-bold">Ups, your cart's empty</h3>
                    </div>

                    <div class="text-sm lg:text-base text-center mt-2 text-gray-500">
                        Let's take a look at our amazing products
                    </div>

                        <div class="flex justify-center mt-6">
                            <a href="{{ route('home') }}" class="text-sm lg:text-base w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-8 py-2 bg-indigo-600 font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto">
                                Back to Home
                            </a>
                        </div>
                </div>
